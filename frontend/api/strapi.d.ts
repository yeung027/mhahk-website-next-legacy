...
export interface paths {
    "/abouts": {
        ...
        get: operations["get/abouts"];
        put?: never;
        post: operations["post/abouts"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/abouts/{id}": {
        ...
        get: operations["get/abouts/{id}"];
        put: operations["put/abouts/{id}"];
        post?: never;
        delete: operations["delete/abouts/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/page-groups": {
        ...
        get: operations["get/page-groups"];
        put?: never;
        post: operations["post/page-groups"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/page-groups/{id}": {
        ...
        get: operations["get/page-groups/{id}"];
        put: operations["put/page-groups/{id}"];
        post?: never;
        delete: operations["delete/page-groups/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/services/{id}": {
        ...
        get: operations["get/services/{id}"];
        put: operations["put/services/{id}"];
        post?: never;
        delete: operations["delete/services/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    schemas: {
        ...
        FooterRequest: {
            data: {
                nav_groups?: components["schemas"]["FooterFooterNavGroupComponent"][];
                xl_only_nav_icons?: components["schemas"]["FooterFooterXlOnlyNavIconComponent"][];
                icon_groups?: components["schemas"]["FooterFooterIconGroupComponent"][];
                bottom_paragraphs?: components["schemas"]["FooterFooterBottomParagraphComponent"][];
                locale?: string;
                localizations?: (number | string)[];
            };
        };
        ...
        FooterFooterNavItemComponent: {
            id?: number;
            title?: string;
            url?: string;
        };
        FooterFooterNavSubGroupComponent: {
            id?: number;
            title?: string;
            items?: components["schemas"]["FooterFooterNavItemComponent"][];
        };
        FooterFooterNavGroupComponent: {
            id?: number;
            subgroup?: components["schemas"]["FooterFooterNavSubGroupComponent"][];
        };
        FooterFooterXlOnlyNavIconComponent: {
            id?: number;
            image?: {
                id?: number;
                documentId?: string;
        ...
        FooterFooterIconGroupComponent: {
            id?: number;
            icons?: components["schemas"]["FooterFooterIconComponent"][];
        };
        FooterFooterBottomParagraphComponent: {
            id?: number;
            content?: unknown;
        };
        IndexPageRequest: {
        ...
        PageGroupRequest: {
            data: {
                pages: components["schemas"]["PagePageComponent"][];
                slug: string;
                locale?: string;
                localizations?: (number | string)[];
            };
        };
        PageGroupListResponse: {
            data?: components["schemas"]["PageGroup"][];
            meta?: {
                pagination?: {
                    page?: number;
                    pageSize?: number;
...
export interface operations {
    ...
    "get/page-groups": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PageGroupListResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    "post/page-groups": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PageGroupRequest"];
            };
        };
        responses: {
            /** @description OK */
